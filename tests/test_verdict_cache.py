...
def test_cached_verdict_returns_latest(tmp_path):
    ...
    append_record(
        log, {"type": "semantic_verdict", "diff_id": "d1", "rule": "r1", "verdict": "violation"}
    )
    append_record(
        log, {"type": "semantic_verdict", "diff_id": "d1", "rule": "r1", "verdict": "pass"}
    )
    append_record(
        log, {"type": "semantic_verdict", "diff_id": "d1", "rule": "r2", "verdict": "violation"}
    )
